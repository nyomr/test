  ...
  try {
    ...
    async function loadMoreJobsOnce() {
      ...
      try {
        ...
        await page.waitForSelector(loadMoreButtonSelector, { visible: true, timeout: 30000 }); // Perpanjang batas waktu menjadi 10 detik
        ...
        await page.waitForFunction(
          () => new Promise(resolve => setTimeout(resolve, 15000)) // Perpanjang waktu tunggu menjadi 5 detik
        );
